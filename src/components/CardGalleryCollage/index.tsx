...
export function CardGalleryCollage({data, patient_id, patient_query, position}: IGalleryCollageProps){
  ...
  const handleCreateCollage = async () => {
    setCreateCollage(true)
      ...
      .catch((_error)=> {
        ...
        return Alert.alert("Colagem de fotos", "Error em fazer a criação de uma colagem para um usuário !")
      });
